class Shadow {
    constructor(Shadow_box, shadowCard) {
        ...
        this.alpha_value = this.ShadowCard.mainShadowData[this.ShadowCard.count].color.slice(7, 9)
    ...
    //     if (Formats.includes(this.Color_format)) {
    ...
    //         this.Color_format_data.innerHTML = [0, 1, 2].map(i => `
    //             <div class="row row-col gap-10 col-4">
    //                 <div class="color_format_index_value row space-between align-center text-upper ${isLight}">
    //                     <p>[</p>
    //                     <p>${this.Color_format[i]}</p>
    //                     <p>]</p>
    //                 </div>
    //                 <h3 class="text-center text-upper ${isLight}">${this.Shadow_box_color_format_value[i]}</h3>
    //             </div>
    //         `).join("");
    //     }
    // }
    ...
    //     <p>]</p>
    //     </div>
    //     <h3 class="temph3_2 text-center text-upper ${this.BgColorFinal.colorData.tag === "Light" ? 'black' : 'white'}">${this.Shadow_box_alpha_value}</h3>
    //     `
    //     }
    // }
